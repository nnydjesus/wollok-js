export const $wollok = {
  $lang: {
    ...
    $Set: {
      ...
      join() { /* TODO:*/ throw new ReferenceError('To be implemented') },
      join(separator) { /* TODO:*/ throw new ReferenceError('To be implemented') },
      equals(other) { /* TODO:*/ throw new ReferenceError('To be implemented') },
      '=='(other) { /* TODO:*/ throw new ReferenceError('To be implemented') },
    },

    List: {
      get(index) { /* TODO:*/ throw new ReferenceError('To be implemented') },
    ...
    String: {
      ...
      substring(length) { /* TODO:*/ throw new ReferenceError('To be implemented') },
      substring(startIndex, length) { /* TODO:*/ throw new ReferenceError('To be implemented') },
