...
constructorDeclaration = 'constructor' _ parameters:parameters _ base:('=' _ (self/super) _ arguments)? _ sentences:block? {return ConstructorDeclaration(...parameters)(base && base[2], base && base[4])(...sentences||[])}
