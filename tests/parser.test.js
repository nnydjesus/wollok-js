...
const fixture = {
  ...
  class: {
    ...
    'class C inherits p.S { var v; method m() }': Class('C')(SuperType('p.S')())(Field(Variable('v'), true), Method('m')()()),
    'class C inherits p.S(a,b) { var v; method m() }': Class('C')(SuperType('p.S')(Variable('a'), Variable('b')))(Field(Variable('v'), true), Method('m')()()),
    'class C inherits p.S mixed with p.M { }': Class('C')(SuperType('p.S')(), 'p.M')(),
    'class C inherits p.S mixed with p.M { var v; method m() }': Class('C')(SuperType('p.S')(), 'p.M')(Field(Variable('v'), true), Method('m')()()),
    'class C inherits p.S mixed with p.M and p.N { var v; method m() }': Class('C')(SuperType('p.S')(), 'p.M', 'p.N')(Field(Variable('v'), true), Method('m')()()),
    'class C mixed with p.M and p.N { var v; method m() }': Class('C')(undefined, 'p.M', 'p.N')(Field(Variable('v'), true), Method('m')()()),
  ...
  namedObject: {
    ...
    'object O inherits p.S { var v; method m() }': Singleton('O')(SuperType('p.S')())(Field(Variable('v'), true), Method('m')()()),
    'object O inherits p.S(a,b) { var v; method m() }': Singleton('O')(SuperType('p.S')(Variable('a'), Variable('b')))(Field(Variable('v'), true), Method('m')()()),
    'object O inherits p.S mixed with p.M { var v; method m() }': Singleton('O')(SuperType('p.S')(), 'p.M')(Field(Variable('v'), true), Method('m')()()),
    'object O inherits p.S mixed with p.M and p.N { var v; method m() }': Singleton('O')(SuperType('p.S')(), 'p.M', 'p.N')(Field(Variable('v'), true), Method('m')()()),
    'object O mixed with p.M and p.N { var v; method m() }': Singleton('O')(undefined, 'p.M', 'p.N')(Field(Variable('v'), true), Method('m')()()),
  ...
  Constructor: {
    ...
    'constructor(p) = self()': Constructor(Parameter('p'))(SelfLiteral, [])(),
    'constructor(p) = self(p,p + 1)': Constructor(Parameter('p'))(SelfLiteral, [Variable('p'), Send(Variable('p'), '+')(Literal(1))])(),
    'constructor(p) = self(p,p + 1) { p++ }': Constructor(Parameter('p'))(SelfLiteral, [Variable('p'), Send(Variable('p'), '+')(Literal(1))])(Send(Variable('p'), '_++')()),
    'constructor(p) = super()': Constructor(Parameter('p'))(SuperLiteral, [])(),
    'constructor(p) = super(p,p + 1)': Constructor(Parameter('p'))(SuperLiteral, [Variable('p'), Send(Variable('p'), '+')(Literal(1))])(),
    'constructor(p) = super(p,p + 1) { p++ }': Constructor(Parameter('p'))(SuperLiteral, [Variable('p'), Send(Variable('p'), '+')(Literal(1))])(Send(Variable('p'), '_++')()),
    'constructor': FAIL,
    'constructor(': FAIL,
    'constructor() = { }': FAIL,
  ...
  literal: {
    ...
    '#{1 + b, -5}': SetLiteral(Send(Literal(1), '+')(Variable('b')), Send(Literal(5), '-_')()),
    '[': FAIL,
    '[1,2,': FAIL,
    '#{': FAIL,
    '#{1': FAIL,
    ...
    'object inherits p.S { var v; method m() }': Singleton()(SuperType('p.S')())(Field(Variable('v'), true), Method('m')()()),
    'object inherits p.S(a,b) { var v; method m() }': Singleton()(SuperType('p.S')(Variable('a'), Variable('b')))(Field(Variable('v'), true), Method('m')()()),
    'object inherits p.S mixed with p.M { var v; method m() }': Singleton()(SuperType('p.S')(), 'p.M')(Field(Variable('v'), true), Method('m')()()),
    'object inherits p.S mixed with p.M and p.N { var v; method m() }': Singleton()(SuperType('p.S')(), 'p.M', 'p.N')(Field(Variable('v'), true), Method('m')()()),
    'object mixed with p.M and p.N { var v; method m() }': Singleton()(undefined, 'p.M', 'p.N')(Field(Variable('v'), true), Method('m')()()),
